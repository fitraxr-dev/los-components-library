...
const ListPage = () => {
  ...
  const canAddNew = useCheckAccess(accessid.PARAMETER_BENEFICIAL_OWNER_CREATE);
  ...
  const handleAddItemGroup = () => {
    const nextPath = replacePath(MASTER_PARAMETER.PARAMETER_BENEFICIAL_OWNER_CREATE_PAGE, {});
  ...
  return (
    <>
      <Title title="Maintenance Parameter Beneficial Owner" />
