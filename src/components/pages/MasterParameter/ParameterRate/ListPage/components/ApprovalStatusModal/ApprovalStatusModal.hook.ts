...
import useGetParameterRateSubmissionList from '../../hooks/useGetParameterRateSubmissionList';
...
const useApprovalStatusModal = () => {
  ...
  const { data: parameterRateSubmissionData, isLoading } = useGetParameterRateSubmissionList({
    filter: {
      ...filter?.filter,
    },
    page: {
