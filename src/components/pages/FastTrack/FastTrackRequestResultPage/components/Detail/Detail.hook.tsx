...
//   const { isDpop, isStaff, stepper } = useFastTrackContext();
...
//   const newFastTrackRequestPath = replacePath(fastTrack.DETAIL_REQUEST_PAGE, { processId });
//   const newFastTrackDocumentVerif = replacePath(fastTrack.BUCKET_DOCUMENT_VERIFICATION_PAGE, { processId });
//   const isRequestMode = matchesPathname(pathname, newFastTrackRequestPath);
//   const isVerifMode = matchesPathname(pathname, newFastTrackDocumentVerif) &&
// stepper.from === 'ASK_FOR_INFO' && isDpop && isStaff;
