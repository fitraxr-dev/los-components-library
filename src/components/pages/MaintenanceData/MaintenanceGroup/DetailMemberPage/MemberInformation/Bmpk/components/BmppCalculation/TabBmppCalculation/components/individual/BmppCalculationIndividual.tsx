...
import useBmppCalculationIndividual
  from '@/components/pages/MaintenanceData/MaintenanceGroup/DetailMemberPage/MemberInformation/Bmpk/components/BmppCalculation/TabBmppCalculation/components/individual/BmppCalculationIndividual.hook';
                      ...
                      <Box sx={{ bgcolor: '#284A63', height: '100%', width: '100%' }}>
                        ...
                        >
                          <TextStyle variant="body5" color={theme.palette.white.main}>
                            {dataMasterDebtor?.generalInformation?.lastModified
                              ? (() => {
                                const date = new Date(dataMasterDebtor.generalInformation.lastModified);
                                ...
                                return `Hasil Rating DEPI pada tanggal ${day} ${month} ${year} ` +
