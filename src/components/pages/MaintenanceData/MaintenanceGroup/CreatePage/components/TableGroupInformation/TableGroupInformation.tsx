...
const TableGroupInformation = ({ disabledForm, findDataMaster }) => {
          ...
          <Controller
            ...
            render={({ field }) => (
              <Input
                ...
                label="Nama Group"
                isMandatory
                hasDataMaster={findDataMaster('tableGroup.name')}
              />
            )}
          />
          ...
          <Controller
            ...
            render={({ field }) => (
              <Input
                ...
                isMandatory
                hasDataMaster={findDataMaster('tableGroup.customerGroupType', groupTypeList)}
              />
            )}
          />
          ...
          <Controller
            ...
            render={({ field }) => (
              <Input
                ...
                isMandatory
                hasDataMaster={findDataMaster('tableGroup.sector', sectorList)}
              />
            )}
          />
          ...
          <Controller
            ...
            render={({ field }) => (
              <Input
                ...
                isMandatory
                hasDataMaster={findDataMaster('tableGroup.yearFounded')}
              />
            )
            }
          />
          ...
          <Controller
            ...
            render={({ field }) => (
              <Input
                ...
                isMandatory
                hasDataMaster={findDataMaster('tableGroup.isRelatedSmi')}
              />
            )}
          />
        </Box>
