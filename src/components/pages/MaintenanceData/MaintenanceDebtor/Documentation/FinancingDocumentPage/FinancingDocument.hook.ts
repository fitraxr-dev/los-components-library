...
import { tableHeaderList } from './FinancingDocument.constants';

import type { SearchValue } from '@/components/shared/Input/components/Search/Search.types';
import type { TableHeader } from '@/components/shared/Table/Table.types';


const useFinancingDocument = () => {
  ...
  useEffect(() => {
    recordActivity({
      ...
      remarks: 'view maintenance customer financing document page',
    });
  }, []);
  ...
  const payload = {
    ...
    documentCategory: 'FINANCING_DOCUMENT',
  };
...
export default useFinancingDocument;
