export const AlMusyarakahMutanaqisahData: MasintonForm = {
  ...
  exchange_rate_total_partnership: {
    error: false,
    errorMessage: '',
    value: '',
  },
