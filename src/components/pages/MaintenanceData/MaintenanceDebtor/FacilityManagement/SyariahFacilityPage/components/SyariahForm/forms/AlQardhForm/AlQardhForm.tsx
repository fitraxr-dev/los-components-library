          ...
          <Box sx={{ position: 'relative' }}>
                ...
                <Tooltip
                  ...
                  title={
                    (() => {
                      ...
                      const currentCurrencyAlQardhLoanAmount = currency_al_qardh_loan_amount?.value;
            ...
            <RowWrapper sx={{ alignItems: 'center', gap: 1 }}>
              ...
              <Currency
                ...
                isMandatory={false}
                label=""
                placeholder="Input Jumlah/nilai pinjaman Al-Qardh"
                containerSx={{ flex: 1 }}
            ...
            <Box sx={{ position: 'relative' }}>
              <Box sx={{ alignItems: 'center', display: 'flex', gap: 1, mb: 1.175 }}>
                <TextStyle variant="body4" weight={600} color={disabled ? theme.palette.custom.gray30 : theme.palette.grey[400]}>
                  Jumlah/Nilai pinjaman Al-Qardh (dalam Rp)
                </TextStyle>
              </Box>
              <Currency
                currencyList={currencyDropdownList}
                label=""
                placeholder="Jumlah Pinjaman (dalam Rp)"
                containerSx={{ flex: 1 }}
          ...
          >
            <Box sx={{ alignItems: 'center', display: 'flex', gap: 1, mb: 1 }}>
              ...
              <TextStyle variant="body4" color={theme.palette.text.secondary} sx={{ lineHeight: 1.5 }}>
                Checkbox pada Jumlah/Nilai pinjaman Al-Qardh akan aktif
        ...
        >
          ...
          >
            ...
            <Input
              ...
              placeholder="Cara Bayar Pinjaman"
              containerSx={{ flex: 1 }}
