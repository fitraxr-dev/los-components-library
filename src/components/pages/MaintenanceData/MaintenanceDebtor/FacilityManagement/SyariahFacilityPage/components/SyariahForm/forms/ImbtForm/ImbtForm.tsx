                ...
                <Tooltip
                  ...
                  title={
                    (() => {
                      ...
                      const currentCurrencyFacilityValue = currency_facility_value?.value;
          ...
          >
            <Box sx={{ alignItems: 'center', display: 'flex', gap: 1, mb: 1 }}>
              ...
              <TextStyle variant="body4" color={theme.palette.text.secondary} sx={{ lineHeight: 1.5 }}>
                Checkbox pada Nilai Fasilitas Pembiayaan akan aktif
        ...
        >
          ...
          >
            ...
            <Input
              ...
              type="dropdown"
              placeholder="Masa Penyediaan Objek Ijaroh/Sewa"
              containerSx={{ flex: 1 }}
