...
import useInquiryLimitList from './InquiryLimitList.hook';


const InquiryLimitList = () => {
  const {
    filter,
    filterList,
    itemPerPage,
  ...
  return (
    <ColumnWrapper marginY={3} gap={theme.spacing(3)}>
      <Title title="List Inquiry Limit" />

      <SectionTitle title = "List Inquiry Limit" isOpen>
        <Box sx={{ width: '45vw' }}>
...
export default InquiryLimitList;
