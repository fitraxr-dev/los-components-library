...
import TableDebtorInformationLocal from '../TableDebtorInformationLocal/TableDebtorInformationLocal';
...
const BmppCalculation = (props: { params: { processId: string; calculationId: string} }) => {
