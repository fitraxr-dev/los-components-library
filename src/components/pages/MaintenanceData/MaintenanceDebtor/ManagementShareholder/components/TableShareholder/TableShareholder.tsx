...
import ModalShareholderDetailNew from '../NewModel/ModalShareholderDetailNew';
import ModalShareholderNew from '../NewModel/ModalShareholderNew';
...
const TableShareholder = ({ isPemda }: {isPemda?: boolean}) => {
  ...
  return (
    <ColumnWrapper sx={{ gap: 3 }}>
      ...
      <ModalDef
        id={modalData.MODAL_SHAREHOLDER_NEW}
        component={ModalShareholderNew}
      />
      ...
      <ModalDef
        id={modalData.MODAL_SHAREHOLDER_DETAIL_NEW}
        component={ModalShareholderDetailNew}
      />
    </ColumnWrapper>
  );
};
