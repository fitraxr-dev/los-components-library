  ...
  return (
    <>
      <Input
        ...
        type="text"
        placeholder="Input Object Istishna"
        containerSx={{ flex: 1 }}
      ...
      <Input
        ...
        type="dropdown"
        placeholder="Input Metode Pembayaran Harga Jual"
        containerSx={{ flex: 1 }}
      ...
      <Input
        ...
        type="text"
        placeholder="Input Masa Penyediaan Objek Istishna"
        containerSx={{ flex: 1 }}
...

      {
        ...
        <Currency
          ...
          placeholder="Margin Istishna (dalam Rp)"
          containerSx={{ flex: 1 }}
...

      {
        ...
        <Currency
          ...
          placeholder="Nilai Angsuran Istishna (dalam Rp)"
          containerSx={{ flex: 1 }}
