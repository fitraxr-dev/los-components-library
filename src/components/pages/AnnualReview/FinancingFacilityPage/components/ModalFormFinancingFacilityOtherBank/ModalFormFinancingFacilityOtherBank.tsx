              ...
              return (
                <Currency
                  ...
                  onChange={(val) => {
                    ...
                    formMethods.setValue('outstanding.currency', val.currency);
                    if (val.currency !== 'USD') {
                      formMethods.setValue('plafondIdr', null);
                      formMethods.setValue('outstandingIdr', null);
              ...
              return (
                <Currency
                  ...
                  onChange={(val) => {
                    ...
                    formMethods.setValue('plafond.currency', val.currency);
            ...
            render={({ field, fieldState: { error, invalid } }) => {
              ...
              return (
                <Currency
                  ...
                  helperText={invalid && _error?.value?.message}
                  isMandatory={formMethods.watch('plafond.currency') === 'USD'}
          ...
          <Controller
            ...
            render={({ field, fieldState: { error } }) => (
              <Currency
                ...
                containerSx={{ flex: 1 }}
                value={{ currency: 'IDR', value: formMethods.watch('plafondIdr.value') }}
                error={!!error}
                helperText={error?.message}
              />
            )}
