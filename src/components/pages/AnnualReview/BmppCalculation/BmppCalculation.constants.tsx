...
export const tableHeaderPerhitunganBmpp: TableHeader[] = [
  {
    key: 'index',
    label: 'No',
    sx: { minWidth: '4vw' },
  ...
  {
    key: 'bmppGroupPercentage',
    label: 'Persentase BMPP Group',
    sx: { minWidth: '12vw' },
  },
  {
    key: 'bmppGroupConclusion',
...
export const tableHeaderGroupProposedFacilitiesListMip: TableHeader[] = [
  ...
  },
  {
    ...
    render: (row) => (
      <TextStyle variant="body4">
        {row.orderValueAfterExchangeRate ? `IDR ${row.orderValueAfterExchangeRate}` : '-'}
      </TextStyle>
    ),
    sx: { minWidth: '12vw', textAlign: 'end', whiteSpace: 'nowrap' },
  },
