...
const useGetProjectStrategicValueById = (payload: RequestByProcessIdDtoString) => {
  const query = useQuery({
    ...
    queryKey: ['mip-project-strategic-value', payload],
...
export default useGetProjectStrategicValueById;
