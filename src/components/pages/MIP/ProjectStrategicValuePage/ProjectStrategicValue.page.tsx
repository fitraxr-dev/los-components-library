...
const ProjectStrategicValuePage = () => {
  ...
  const {
    ...
    handleSave,
    isAutoSaveFetching,
  } = useProjectStrategicValue(container);


  return (
    <ColumnWrapper sx={{ gap: 3 }}>
      <Title title="Nilai Strategis Proyek yang Dibiayai" />
      ...
      <WordEditor
        ...
        initialValue={projectStrategicValueDetail?.description}
        onSave={(blob) => {
...
export default ProjectStrategicValuePage;
