...
import { useFinancialAnalysis } from './FinancialAnalysis.hook';
...
const FinancialAnalysisPage = () => {
  ...
  const {
    ...
    handleSave,
    isAutoSaveFetching,
  } = useFinancialAnalysis(container);

  return (
    <ColumnWrapper sx={{ gap: 3 }}>
      <Title title="Analisis Keuangan" />
      ...
      <WordEditor
        ...
        initialValue={financialAnalysisDetail?.description}
        onSave={(blob) => {
