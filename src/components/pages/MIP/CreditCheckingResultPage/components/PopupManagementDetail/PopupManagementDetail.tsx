...
import { usePopupManagementDetail } from './PopupManagementDetail.hook';

import type { PopupManagementDetailProps } from './PopupManagementDetail.types';
...
const PopupManagementDetail = NiceModal.create(({
  ...
  const { cellDataWithDetail } = usePopupManagementDetail(id);
