...
import { useFundedProjectAnalysis } from './FundedProjectAnalysis.hook';


const FundedProjectAnalysisPage = () => {
  ...
  const {
    ...
    setShouldGoNext,
    handleSave,
  } = useFundedProjectAnalysis(container);


  return (
    <ColumnWrapper sx={{ gap: 3 }}>
      <Title title="Analysis Proyek yang Dibiayai" />
      ...
      <WordEditor
        ...
        initialValue={fundedProjectAnalysisDetail?.description}
        onSave={(blob) => {
...
export default FundedProjectAnalysisPage;
