...
import { TABLE_HEADER } from './Collaboration.contants';
import useGetBucketCollaboration from './hooks/useGetUserCollaboration';

import type { TableHeader } from '@/components/shared/Table/Table.types';


const useApprovalList = () => {
  const [page, setPage] = useState(1);
  const [pageSize, setPageSize] = useState(10);
  const [filter, setFilter] = useSessionStorage('filter-component-risalahrapat-collaboration', null);
