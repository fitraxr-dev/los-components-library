  ...
  return (
    <>
      ...
      <Input
        ...
        type="dropdown"
        placeholder={getLabel('loan_payment_method', 'Input Cara Bayar Pinjaman')}
        containerSx={{ flex: 1 }}
      ...
      <Currency
        label={getLabel('al_qardh_loan_amount', 'Jumlah / Nilai Pinjaman Al-Qardh')}
        placeholder={getLabel('al_qardh_loan_amount', 'Jumlah / Nilai Pinjaman Al-Qardh')}
        containerSx={{ flex: 1 }}
...

      {
        currency_al_qardh_loan_amount.value === 'USD' &&
        <Currency
          label={getLabel('al_qardh_loan_amount_idr', 'Jumlah / Nilai Pinjaman Al-Qardh (dalam Rp)')}
          placeholder={getLabel('al_qardh_loan_amount_idr', 'Jumlah / Nilai Pinjaman Al-Qardh (dalam Rp)')}
          containerSx={{ flex: 1 }}
...

      {
        currency_administration_fee.value === 'USD' &&
        <Currency
          label={getLabel('administration_fee_idr', 'Biaya Administrasi (dalam Rp)')}
          placeholder={getLabel('administration_fee_idr', 'Biaya Administrasi (dalam Rp)')}
          containerSx={{ flex: 1 }}
      ...
      <Currency
        label={getLabel('installment_value', 'Nilai Angsuran')}
...

      {
        currency_installment_value.value === 'USD' &&
        <Currency
          label={getLabel('installment_value_idr', 'Nilai Angsuran (dalam Rp)')}
          placeholder={getLabel('installment_value_idr', 'Nilai Angsuran (dalam Rp)')}
          containerSx={{ flex: 1 }}
