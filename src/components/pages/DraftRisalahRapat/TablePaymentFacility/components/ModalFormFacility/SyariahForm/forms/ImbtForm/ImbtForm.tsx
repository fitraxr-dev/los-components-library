...
const ImbtForm = (props: SyariahFormsProps) => {
  ...
  return (
    <>
      <Input
        label={getLabel('imbt_object', 'Objek IMBT')}
        type="text"
        placeholder={getLabel('imbt_object', 'Input Objek IMBT')}
        containerSx={{ flex: 1 }}
      ...
      <Input
        ...
        type="dropdown"
        placeholder={getLabel('imbt_object_transfer_agreement', 'Choose Akad Pengalihan Objek IMBT')}
        containerSx={{ flex: 1 }}
        dropdownList={Dimbt_object_transfer_agreement}
        value={imbt_object_transfer_agreement.value}
        onChange={(val) => masintonChange('imbt_object_transfer_agreement', val)}
