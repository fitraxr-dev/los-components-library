...
const ModalDetailFacility = NiceModal.create((props: any) => {

  const theme = useTheme();
  // Ensure we use the same modal ID as defined in TableFinancingFacilitySubmit
          ...
          <ColumnWrapper>
            ...
            >
              {facilityData.map((item: any, index: number) => {
                if (item.label === 'Nominal Pengajuan' || item.label === 'Nominal Pembiayaan' || item.label === 'Nominal Pengajuan (dalam Rp)' || item.label === 'Nilai Pembiayaan (dalam Rp)') {
                  return (
                    <Cell
                      key={index}
                      titleNode={
                            ...
                            <Tooltip
                              ...
                              title={
                                (() => {
                                  ...
                                  const usdExchangeRate = currencyDropdownList?.find((item: any) =>
                                    item.value === 'USD')?.rate;
