...
export type UseEligibilityReviewAccessReturn = {
  list: ModuleAccess;
...
export const useEligibilityReviewAccess = (): UseEligibilityReviewAccessReturn => {
  const list = useModuleAccess('LIST_ELIGIBILITY_REVIEW');
  const assignment = useModuleAccess('ASSIGNMENT_ELIGIBILITY_REVIEW');
  const monitoring = useModuleAccess('MONITORING_ELIGIBILITY_REVIEW');
...
export default useEligibilityReviewAccess;
