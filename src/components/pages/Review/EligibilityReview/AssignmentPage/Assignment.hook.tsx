...
export const useAssignment = () => {
  const [filter, setFilter] = useSessionStorage('filter-component-eligibityreview-assignment', null);
  ...
  const canViewEligibility = useCheckAccess(accessid.ASSIGNMENT_ELIGIBILITY_REVIEW_VIEW);
  // --- PARAMETER ---
