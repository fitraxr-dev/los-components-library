...
export type UseShariahComplianceAccessReturn = {
  list: ModuleAccess;
...
export const useShariahComplianceAccess = (): UseShariahComplianceAccessReturn => {
  const list = useModuleAccess('SHARIAH_COMPLIANCE_REVIEW_BUCKET_LIST');
  const assignment = useModuleAccess('SHARIAH_COMPLIANCE_REVIEW_ASSIGNMENT');
  const monitoring = useModuleAccess('SHARIAH_COMPLIANCE_REVIEW_MONITORING');
...
export default useShariahComplianceAccess;
