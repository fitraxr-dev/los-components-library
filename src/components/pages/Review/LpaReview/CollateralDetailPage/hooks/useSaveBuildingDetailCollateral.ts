...
import type { CollateralBuildingRequestDto } from '@/services/openapi/lpa-service';


const useSaveCollateralBuilding = ({
  onSuccess = (data: any) => {},
  onError = () => {},
}) => {
  ...
  const mutation = useMutation({
    mutationFn: async (payload: CollateralBuildingRequestDto) => {
      ...
      const res = await API('lpa.collateralBuilding.save', {
        data: formData,
        headers: {
...
export default useSaveCollateralBuilding;
