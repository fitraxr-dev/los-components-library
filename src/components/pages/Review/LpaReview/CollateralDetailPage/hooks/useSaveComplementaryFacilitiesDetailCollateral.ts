...
import type { CollateralComplementaryFacilitiesRequestDto } from '@/services/openapi/lpa-service';


const useSaveCollateralComplementaryFacilities = ({
  onSuccess = (data: any) => {},
  onError = () => {},
}) => {
  ...
  const mutation = useMutation({
    mutationFn: async (payload: CollateralComplementaryFacilitiesRequestDto) => {
      ...
      const res = await API('lpa.collateralComplementaryFacilities.save', {
        data: formData,
        headers: {
...
export default useSaveCollateralComplementaryFacilities;
