...
import type { CollateralInventoryRequestDto } from '@/services/openapi/lpa-service';


const useSaveCollateralInventory = ({
  onSuccess = (data: any) => {},
  onError = () => {},
}) => {
  ...
  const mutation = useMutation({
    mutationFn: async (payload: CollateralInventoryRequestDto) => {
      ...
      const res = await API('lpa.collateralInventory.save', {
        data: formData,
        headers: {
...
export default useSaveCollateralInventory;
