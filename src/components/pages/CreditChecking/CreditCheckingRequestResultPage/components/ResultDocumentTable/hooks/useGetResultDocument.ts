    ...
    queries: [
      {
        ...
        queryKey: ['credit-checking', 'result', 'summary-documents', summaryPayload],
        ...documentConfig,
      },
      {
        enabled,
        queryFn: async () => {
          try {
            const res = await API('creditChecking.result.selectedDocuments', {
        ...
        queryKey: ['credit-checking', 'result', 'selected-documents', selectedPayload],
        ...selectedConfig,
      },
    ],
  });
