...
import { useFinancingDocumentDraftModal } from './FinancingDocumentDraftModal.hook';


const FinancingDocumentDraftModal = create(() => {
  ...
  } = useFinancingDocumentDraftModal();
...
export default FinancingDocumentDraftModal;
