  ...
  switch (status) {
    case 'isDuplicated':
      content = {
        ...
        textStatus: 'Nama Group sudah terdaftar dalam database. Silakan pilih Group yang sudah ada.',
      };
      break;
    case 'isSimilar':
      content = {
        ...
        textStatus: 'Terdapat Group dengan nama yang serupa dengan Group yang ada pada database. Silakan pilih Group yang sudah ada atau buat Group baru.',
      };
      break;
  }
