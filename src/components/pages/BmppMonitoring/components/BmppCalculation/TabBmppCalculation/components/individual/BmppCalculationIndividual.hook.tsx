...
import type { BmppGroupsComponentResponseDto, BmppGroupsRequestDtoBmppTypeEnum } from '@/services/openapi/mip-service';
...
const useBmppCalculationIndividual = (props: UseTabCalculationProps) => {
  ...
  const { data: groupData } = useGetGroupList({
    filter: {
      ...
      isCustomerMaintenance: isMaintenanceCustomer ?? undefined,
    },
    page: {
      itemPerPage: 25,
      noPage: 1,
