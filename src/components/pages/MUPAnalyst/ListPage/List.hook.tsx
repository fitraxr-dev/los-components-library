...
const useList = () => {
  ...
  const { data: mupStatusOptions } = useGetParameterList('analystStatusFilter');
  ...
  useEffect(() => {
    ...
    recordActivity({
      ...
      remarks: 'view MUP Analyst list page',
    });
  }, [recordActivity]);
      ...
      options: [
        {
          ...
          onClick: (data: BucketResponseDto) => {
            recordActivity({
              ...
              module: TypeModule.MUP,
              process: TypeProcess.MUP_ANALYST,
              remarks: `view MUP Analyst detail for ${data.debtorName}`,
            });
            router.push(
              replacePath(
                mupAnalyst.DEBTOR_INFORMATION_PAGE,
