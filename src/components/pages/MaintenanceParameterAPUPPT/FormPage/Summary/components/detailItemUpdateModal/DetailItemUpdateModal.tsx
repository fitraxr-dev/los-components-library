...
const DetailItemUpdateModal = NiceModal.create(({ data }: any) => {
  const modalId = 'MODAL_DETAIL_ITEM_UPDATE';
        ...
        <ColumnWrapper sx={{ gap: 2 }}>
          ...
          <Box>
            <Input
              type="text"
              label="Nomor Item"
              value={previousData?.noItem?.toString() || '-'}
              disabled={true}
          ...
          <Box>
            <Input
              type="area"
              label="Item"
              value={removeHtml(previousData?.item) || '-'}
              disabled={true}
        ...
        <ColumnWrapper sx={{ gap: 2 }}>
          ...
          <Box>
            <Input
              type="text"
              label="Nomor Item"
              value={lastModifiedData?.noItem?.toString() || '-'}
              disabled={true}
              placeholder="Enter Nomor Item"
            />
          </Box>
          ...
          <Box>
            <Input
              type="area"
              label="Item"
              value={removeHtml(lastModifiedData?.item) || '-'}
              disabled={true}
              placeholder="Enter Item description"
              rows={4}
            />
...
export default DetailItemUpdateModal;
