...
const DetailSubItemUpdateModal = NiceModal.create(({ data }: any) => {
  const modalId = 'MODAL_DETAIL_SUB_ITEM_UPDATE';
        ...
        <ColumnWrapper sx={{ gap: 2 }}>
          ...
          <Box>
            <Input
              type="text"
              label="No. Sub Item"
              value={previousData?.noSubItem?.toString() || '-'}
              disabled={true}
          ...
          <Box>
            <Input
              type="area"
              label="Sub Item"
              value={removeHtml(previousData?.subItem) || '-'}
              disabled={true}
        ...
        <ColumnWrapper sx={{ gap: 2 }}>
          ...
          <Box>
            <Input
              type="text"
              label="No. Sub Item"
              value={lastModifiedData?.noSubItem?.toString() || '-'}
              disabled={true}
              placeholder="Enter No. Sub Item"
            />
          </Box>
          ...
          <Box>
            <Input
              type="area"
              label="Sub Item"
              value={removeHtml(lastModifiedData?.subItem) || '-'}
              disabled={true}
              placeholder="Enter Sub Item description"
              rows={4}
            />
...
export default DetailSubItemUpdateModal;
