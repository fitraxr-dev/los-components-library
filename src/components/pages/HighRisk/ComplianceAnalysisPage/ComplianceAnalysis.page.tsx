...
import { useComplianceAnalysis } from './ComplianceAnalysis.hook';
...
const PeerComparisonPage = () => {
  ...
  return (
    <ColumnWrapper gap={theme.spacing(3)}>
      ...
      <WordEditor
        id="complianceAnalysisDesc"
        container={container}
        setContainer={setContainer}
        isLoading={isComplianceAnalysisLoading}
        initialValue={complianceAnalysisData?.description}
        ...
        {viewOnly ? (
          ...
          <>
            <Button
              ...
              disabled={isWordEditorEmpty?.complianceAnalysisDesc || isAutoSaveFetching}
              isLoading={isSaveLoading}
            >
            ...
            <Button
              ...
              disabled={isWordEditorEmpty?.complianceAnalysisDesc}
              isLoading={isSaveLoading}
            >
              Next
            </Button>
