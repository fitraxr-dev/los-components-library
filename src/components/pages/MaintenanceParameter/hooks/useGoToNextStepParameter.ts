...
const useGoToNextStepParameter = () => {
  ...
  function goToNextStep() {
    ...
    // Define step sequence for MaintenanceParameter
    const stepSequence = ['list-of-value', 'summary', 'validasi'];
...
export default useGoToNextStepParameter;
