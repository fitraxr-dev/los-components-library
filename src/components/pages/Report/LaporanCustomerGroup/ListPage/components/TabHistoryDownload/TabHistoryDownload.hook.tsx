...
import useDownloadReportLaporanCustomerGroup from '@/hooks/services/report/laporan-customer-group/useDownloadReportLaporanCustomerGroup';
import useGenerateHistoryLaporanCustomerGroup from '@/hooks/services/report/laporan-customer-group/useGenerateHistoryLaporanCustomerGroup';
...
const useTabHistoryDownload = () => {
  ...
  const { data, isLoading, refetch } = useGenerateHistoryLaporanCustomerGroup({
    page: {
  ...
  const { mutate: downloadReport, isPending: isDownloading } = useDownloadReportLaporanCustomerGroup({
    onError: (error) => {
    ...
    onSuccess: (response, id) => {
      ...
      try {
        ...
        recordActivity({
          ...
          remarks: 'download file report laporan customer group',
        });
      } catch (error) {
  ...
  const getActionOptions = (row: any) => {
    ...
    switch (status) {
      case 'success':
        return [
          {
            apiDownload: 'report.customerGroup.download',
            iconName: 'download',
