...
import useDownloadReportLogDataInterFaceSuccess from '@/hooks/services/report/log-data-interface-success/useDownloadReportLogDataInterFaceSuccess';
import useGetHistoryLogDataInterfaceSuccess from '@/hooks/services/report/log-data-interface-success/useGetHistoryLogDataInterfaceSuccess';
...
const useTabHistoryDownload = () => {
  ...
  const { data, isLoading, refetch } = useGetHistoryLogDataInterfaceSuccess({
    page: {
  ...
  const { mutate: downloadReport, isPending: isDownloading } = useDownloadReportLogDataInterFaceSuccess({
    onError: (error) => {
    ...
    onSuccess: (response, id) => {
      ...
      try {
        ...
        recordActivity({
          ...
          remarks: 'download file report log data interface success',
        });
      } catch (error) {
