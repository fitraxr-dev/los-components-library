...
import useDownloadReportLaporanCustomerCreditChecking from '@/hooks/services/report/laporan-detail-customer-credit-checking/useDownloadReportLaporanCustomerCreditChecking';
import useGenerateHistoryLaporanCustomerCreditChecking from '@/hooks/services/report/laporan-detail-customer-credit-checking/useGenerateHistoryLaporanCustomerCreditChecking';
...
const useTabHistoryDownload = () => {
  // user access
  const canDownloadFile = useCheckAccess(accessid.REPORT_LAPORAN_CREDIT_CHECKING_DOWNLOAD);
  ...
  const { data, isLoading, refetch } = useGenerateHistoryLaporanCustomerCreditChecking({
    page: {
  ...
  const { mutate: downloadReport, isPending: isDownloading } = useDownloadReportLaporanCustomerCreditChecking({
    onError: (error) => {
