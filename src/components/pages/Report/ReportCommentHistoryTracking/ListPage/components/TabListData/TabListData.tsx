...
const TabListData = () => {
  ...
  useEffect(() => {
    recordActivity({
      ...
      remarks: 'view report comment history checking',
    });
  }, []);
          ...
          <Grid container spacing={isMobile ? 1.5 : 2}>
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <MultipleAutoComplete
                    ...
                    placeholder="Choose Customer Name(s)"
                    label="Customer Name"
            ...
            <Grid item xs={12} md={6}>
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <MultipleAutoComplete
                    id="input-newLosProcess"
                    label="New Los Process"
                    placeholder="Choose New Los Process(s)"
                    dropdownList={moduleProcessNameOptions}
                    value={field.value || []}
                    onChange={(newValues) => {
                      field.onChange(newValues);
                    }}
