...
import useDownloadReportCommentHistoryTracking from '@/hooks/services/report/report-comment-history-tracking/useDownloadReportCommentHistoryTracking';
import useGenerateHistoryCommentHistoryTracking from '@/hooks/services/report/report-comment-history-tracking/useGenerateHistoryCommentHistoryTracking';
...
const useTabHistoryDownload = () => {
  const canDownloadFile = useCheckAccess(accessid.REPORT_COMMENT_HISTORY_TRACKING_DOWNLOAD);
  ...
  const { data, isLoading, refetch } = useGenerateHistoryCommentHistoryTracking({
    page: {
  ...
  const { mutate: downloadReport, isPending: isDownloading } = useDownloadReportCommentHistoryTracking({
    onError: (error) => {
