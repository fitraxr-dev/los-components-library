...
import useGetDataReportBmppGroupDpopDetailExisting from '@/hooks/services/report/report-bmpp-group-dpop/useGetDataReportBmppGroupDpopDetailExisting';
...
const useModalDetail = ({ id }: ModalDetailProps) => {
  ...
  const { data: dataExisting, isFetching: isLoadingExisting } = useGetDataReportBmppGroupDpopDetailExisting({
    filter: {
      calculationId: id,
    },
    page: {
