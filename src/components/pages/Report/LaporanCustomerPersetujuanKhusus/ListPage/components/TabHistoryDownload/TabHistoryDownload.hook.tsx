...
import useDownloadReportLaporanCustomerPersetujuanKhusus from '@/hooks/services/report/laporan-detail-customer-persetujuan-khusus/useDownloadReportLaporanCustomerPersetujuanKhusus';
import useGenerateHistoryLaporanCustomerPersetujuanKhusus from '@/hooks/services/report/laporan-detail-customer-persetujuan-khusus/useGenerateHistoryLaporanCustomerPersetujuanKhusus';
...
const useTabHistoryDownload = () => {
  // user access
  const canDownloadFile = useCheckAccess(accessid.REPORT_LAPORAN_PERSETUJUAN_KHUSUS_DOWNLOAD);
  ...
  const { data, isLoading, refetch } = useGenerateHistoryLaporanCustomerPersetujuanKhusus({
    page: {
  ...
  const { mutate: downloadReport, isPending: isDownloading } = useDownloadReportLaporanCustomerPersetujuanKhusus({
    onError: (error) => {
  ...
  const getActionOptions = (row: any) => {
    ...
    switch (status) {
      case 'success':
        return [
          {
            apiDownload: 'report.logAuditTrailActivity.download',
            iconName: 'download',
