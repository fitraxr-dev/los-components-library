...
const TabListData = () => {
  ...
  useEffect(() => {
    recordActivity({
      ...
      remarks: 'view report tat sla details',
    });
  }, []);
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <Grid container spacing={isMobile ? 1.5 : 2}>
            ...
            <Grid item xs={12} md={6}>
              <Controller
                name="createdDivision"
                control={control}
                render={({ field, fieldState }) => (
                  <MultipleAutoComplete
                    id="input-createdDivision"
                    label="Divisi Creation"
            ...
            <Grid item xs={12} md={6}>
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <MultipleAutoComplete
                    id="input-processStatus"
                    label="Status Process"
                    placeholder="Choose Group Name(s)"
                    dropdownList={statusProcessOptions}
                    value={field.value || []}
                    onChange={(newValues) => {
                      field.onChange(newValues);
                    }}
