...
import useDownloadReportTatSlaDetails from '@/hooks/services/report/report-tat-sla-details/useDownloadReportTatSlaDetails';
import useGenerateHistoryTatSlaDetails from '@/hooks/services/report/report-tat-sla-details/useGenerateHistoryTatSlaDetails';
...
const useTabHistoryDownload = () => {
  ...
  const { data, isLoading, refetch } = useGenerateHistoryTatSlaDetails({
    page: {
  ...
  const { mutate: downloadReport, isPending: isDownloading } = useDownloadReportTatSlaDetails({
    onError: (error) => {
    ...
    onSuccess: (response, id) => {
      ...
      try {
        ...
        recordActivity({
          ...
          remarks: 'download file report tat sla details',
        });
      } catch (error) {
