...
import useDownloadReportLaporanCustomerPkAddendum from '@/hooks/services/report/laporan-detail-customer-pk-addendum/useDownloadReportLaporanCustomerPkAddendum';
import useGenerateHistoryLaporanCustomerPkAddendum from '@/hooks/services/report/laporan-detail-customer-pk-addendum/useGenerateHistoryLaporanCustomerPkAddendum';
...
const useTabHistoryDownload = () => {
  ...
  const { data, isLoading, refetch } = useGenerateHistoryLaporanCustomerPkAddendum({
    page: {
  ...
  const { mutate: downloadReport, isPending: isDownloading } = useDownloadReportLaporanCustomerPkAddendum({
    onError: (error) => {
    ...
    onSuccess: (response, id) => {
      ...
      try {
        ...
        recordActivity({
          ...
          remarks: 'download file report laporan customer pk-addendum',
        });
      } catch (error) {
