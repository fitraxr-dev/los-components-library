...
import useDownloadReportLaporanAssignment from '@/hooks/services/report/laporan-assignment/useDownloadReportLaporanAssignment';
import useGetListHistoryLaporanAssignment from '@/hooks/services/report/laporan-assignment/useGetListHistoryLaporanAssignment';
...
const useTabHistoryDownload = () => {
  ...
  const { data, isLoading, refetch } = useGetListHistoryLaporanAssignment({
    page: {
  ...
  const { mutate: downloadReport, isPending: isDownloading } = useDownloadReportLaporanAssignment({
    onError: (error) => {
