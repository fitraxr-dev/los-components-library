...
import useDownloadAgingReportProsesPembiayaan from '@/hooks/services/report/aging-report-proses-pembiayaan/useDownloadAgingReportProsesPembiayaan';
import useGenerateHistoryAgingReportProsesPembiayaan from '@/hooks/services/report/aging-report-proses-pembiayaan/useGenerateHistoryAgingReportProsesPembiayaan';
...
const useTabHistoryDownload = () => {
  // user access
  const canDownloadFile = useCheckAccess(accessid.REPORT_AGING_REPORT_DOWNLOAD);
  ...
  const { data, isLoading, refetch } = useGenerateHistoryAgingReportProsesPembiayaan({
    page: {
  ...
  const { mutate: downloadReport, isPending: isDownloading } = useDownloadAgingReportProsesPembiayaan({
    onError: (error) => {
