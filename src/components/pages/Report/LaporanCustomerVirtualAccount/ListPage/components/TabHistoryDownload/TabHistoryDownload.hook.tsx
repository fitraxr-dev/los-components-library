...
import useDownloadReportLaporanCustomerVirtualAccount from '@/hooks/services/report/laporan-customer-virtual-account/useDownloadReportLaporanCustomerVirtualAccount';
import useGenerateHistoryLaporanCustomerVirtualAccount from '@/hooks/services/report/laporan-customer-virtual-account/useGenerateHistoryLaporanCustomerVirtualAccount';
...
const useTabHistoryDownload = () => {
  ...
  const { data, isLoading, refetch } = useGenerateHistoryLaporanCustomerVirtualAccount({
    page: {
  ...
  const { mutate: downloadReport, isPending: isDownloading } = useDownloadReportLaporanCustomerVirtualAccount({
    onError: (error) => {
    ...
    onSuccess: (response, id) => {
      ...
      try {
        ...
        recordActivity({
          ...
          remarks: 'download file report laporan customer virtual account',
        });
      } catch (error) {
  ...
  const getActionOptions = (row: any) => {
    ...
    switch (status) {
      case 'success':
        return [
          {
            apiDownload: 'report.customerSiteVisit.download',
            iconName: 'download',
