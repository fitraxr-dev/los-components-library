...
import useDownloadReportLaporanCustomerShareholder from '@/hooks/services/report/laporan-detail-customer-management-shareholder/useDownloadReportLaporanCustomerShareholder';
import useGenerateHistoryLaporanCustomerShareholder from '@/hooks/services/report/laporan-detail-customer-management-shareholder/useGenerateHistoryLaporanCustomerShareholder';
...
const useTabHistoryDownload = () => {
  ...
  // user access
  const canDownloadFile = useCheckAccess(accessid.REPORT_DETAIL_CUSTOMER_SHAREHOLDER_DOWNLOAD);
  ...
  const { data, isLoading, refetch } = useGenerateHistoryLaporanCustomerShareholder({
    page: {
  ...
  const { mutate: downloadReport, isPending: isDownloading } = useDownloadReportLaporanCustomerShareholder({
    onError: (error) => {
    ...
    onSuccess: (response, id) => {
      ...
      recordActivity({
        ...
        remarks: 'download file report detail customer management shareholder',
      });
  ...
  const getActionOptions = (row: any) => {
    ...
    switch (status) {
      case 'success':
        return [
          {
            apiDownload: 'report.customerManagementShareholder.download',
            iconName: 'download',
