...
import useDownloadReportLaporanDetailCustomerPipeline from '@/hooks/services/report/laporan-detail-customer-pipeline/useDownloadReportLaporanDetailCustomerPipeline';
import useGetHistoryLaporanDetailCustomerPipeline from '@/hooks/services/report/laporan-detail-customer-pipeline/useGetHistoryLaporanDetailCustomerPipeline';
...
const useTabHistoryDownload = () => {
  ...
  const { data, isLoading, refetch } = useGetHistoryLaporanDetailCustomerPipeline({
    page: {
  ...
  const { mutate: downloadReport, isPending: isDownloading } = useDownloadReportLaporanDetailCustomerPipeline();
      ...
      onSuccess: (response) => {
        ...
        try {
          ...
          recordActivity({
            ...
            remarks: 'download file report laporan customer pipeline',
          });
        } catch (error) {
  ...
  const getActionOptions = (row: any) => {
    ...
    switch (status) {
      case 'success':
        return [
          {
            apiDownload: 'report.customerPipeline.download',
            iconName: 'download',
