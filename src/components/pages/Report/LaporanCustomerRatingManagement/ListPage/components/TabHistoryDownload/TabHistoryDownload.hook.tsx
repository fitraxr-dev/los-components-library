...
import useDownloadReportLaporanCustomerRatingManagement from '@/hooks/services/report/laporan-detail-customer-rating-management/useDownloadReportLaporanCustomerRatingManagement';
import useGenerateHistoryLaporanCustomerRatingManagement from '@/hooks/services/report/laporan-detail-customer-rating-management/useGenerateHistoryLaporanCustomerRatingManagement';
...
const useTabHistoryDownload = () => {
  // user access
  const canDownloadFile = useCheckAccess(accessid.REPORT_LAPORAN_RATING_MANAGEMENT_DOWNLOAD);
  ...
  const { data, isLoading, refetch } = useGenerateHistoryLaporanCustomerRatingManagement({
    page: {
  ...
  const { mutate: downloadReport, isPending: isDownloading } = useDownloadReportLaporanCustomerRatingManagement({
    onError: (error) => {
