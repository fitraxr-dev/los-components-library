...
import useDownloadReportLaporanCustomerResikoDatabase from '@/hooks/services/report/laporan-detail-customer-resiko-database/useDownloadReportLaporanCustomerResikoDatabase';
import useGenerateHistoryLaporanCustomerResikoDatabase from '@/hooks/services/report/laporan-detail-customer-resiko-database/useGenerateHistoryLaporanCustomerResikoDatabase';
...
const useTabHistoryDownload = () => {
  // user access
  const canDownloadFile = useCheckAccess(accessid.REPORT_LAPORAN_RESIKO_DATABASE_DOWNLOAD);
  ...
  const { data, isLoading, refetch } = useGenerateHistoryLaporanCustomerResikoDatabase({
    page: {
  ...
  const { mutate: downloadReport, isPending: isDownloading } = useDownloadReportLaporanCustomerResikoDatabase({
    onError: (error) => {
