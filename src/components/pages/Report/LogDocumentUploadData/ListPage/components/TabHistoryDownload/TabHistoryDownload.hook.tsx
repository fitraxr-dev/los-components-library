...
import useDownloadReportLogDocumentUploadData from '@/hooks/services/report/log-document-upload-data/useDownloadReportLogDocumentUploadData';
import useGetHistoryReportLogDocumentUploadData from '@/hooks/services/report/log-document-upload-data/useGetHistoryReportLogDocumentUploadData';
...
const useTabHistoryDownload = () => {
  ...
  const { data, isLoading, refetch } = useGetHistoryReportLogDocumentUploadData({
    page: {
  ...
  const { mutate: downloadReport, isPending: isDownloading } = useDownloadReportLogDocumentUploadData({
    onError: (error) => {
    ...
    onSuccess: (response, id) => {
      ...
      try {
        ...
        recordActivity({
          ...
          remarks: 'download file report log document upload data',
        });
      } catch (error) {
