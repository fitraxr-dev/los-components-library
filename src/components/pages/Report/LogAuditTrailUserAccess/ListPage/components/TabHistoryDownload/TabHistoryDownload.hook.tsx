...
import useDownloadReportLogAuditTrailUserAccess from '@/hooks/services/report/log-audit-trail-user-access/useDownloadReportLogAuditTrailUserAccess';
import useGetHistoryLogAuditTrailUserAccess from '@/hooks/services/report/log-audit-trail-user-access/useGetHistoryLogAuditTrailUserAccess';
...
const useTabHistoryDownload = () => {
  ...
  // user access
  const canDownloadFile = useCheckAccess(accessid.REPORT_LOG_AUDIT_TRAIL_USER_ACCESS_DOWNLOAD);
  ...
  const { data, isLoading, refetch } = useGetHistoryLogAuditTrailUserAccess({
    page: {
  ...
  const { mutate: downloadReport, isPending: isDownloading } = useDownloadReportLogAuditTrailUserAccess({
    onError: (error) => {
    ...
    onSuccess: (response, id) => {
      ...
      recordActivity({
        ...
        remarks: 'download file report log audit trail user access',
      });
