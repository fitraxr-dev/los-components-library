...
import useDownloadReportLaporanDetailCustomer from '@/hooks/services/report/laporan-detail-customer/useDownloadReportLaporanDetailCustomer';
import useGetHistoryLaporanDetailCustomer from '@/hooks/services/report/laporan-detail-customer/useGetHistoryLaporanDetailCustomer';
...
const useTabHistoryDownload = () => {
  ...
  const { data, isLoading, refetch } = useGetHistoryLaporanDetailCustomer({
    page: {
  ...
  const { mutate: downloadReport, isPending: isDownloading } = useDownloadReportLaporanDetailCustomer({
    onError: (error) => {
    ...
    onSuccess: (response, id) => {
      ...
      try {
        ...
        recordActivity({
          ...
          remarks: 'download file report laporan detail customer',
        });
      } catch (error) {
  ...
  const getActionOptions = (row: any) => {
    ...
    switch (status) {
      case 'success':
        return [
          {
            apiDownload: 'report.customer.download',
            iconName: 'download',
