...
import useDownloadReportLaporanDetailCustomerSiteVisit from '@/hooks/services/report/laporan-detail-customer-site-visit/useDownloadReportLaporanDetailCustomerSiteVisit';
import useGetHistoryLaporanDetailCustomerSiteVisit from '@/hooks/services/report/laporan-detail-customer-site-visit/useGetHistoryLaporanDetailCustomerSiteVisit';
...
const useTabHistoryDownload = () => {
  ...
  const { data, isLoading, refetch } = useGetHistoryLaporanDetailCustomerSiteVisit({
    page: {
  ...
  const { mutate: downloadReport, isPending: isDownloading } = useDownloadReportLaporanDetailCustomerSiteVisit({
    onError: (error) => {
    ...
    onSuccess: (response, id) => {
      ...
      try {
        ...
        recordActivity({
          ...
          remarks: 'download file report laporan customer site visit',
        });
      } catch (error) {
