...
interface LaporanBasSubmitterDetailProps {
  readonly data: any;
  readonly isLoading: boolean;
}

const LaporanBasSubmitterDetail = ({ data, isLoading }: LaporanBasSubmitterDetailProps) => {
  const detailCellData = [
    ...
    { title: 'Perwakilan Klien', value: data?.perwakilanClient },
    ...
    { title: 'Approver Comment', value: data?.approverComments },
    { title: 'Group Name', value: data?.groupName },
    { title: 'Approver Status', value: data?.approverStatus },
    { title: 'New / Existing Client', value: data?.isNewClient },
...
export default LaporanBasSubmitterDetail;
