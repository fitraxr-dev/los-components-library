...
import useDownloadReportBmppGroup from '@/hooks/services/report/report-bmpp-group/useDownloadReportBmppGroup';
import useGetHistoryBmppGroup from '@/hooks/services/report/report-bmpp-group/useGetHistoryBmppGroup';
...
const useTabHistoryDownload = () => {
  ...
  const { data, isLoading, refetch } = useGetHistoryBmppGroup({
    page: {
  ...
  const { mutate: downloadReport, isPending: isDownloading } = useDownloadReportBmppGroup({
    onError: (error) => {
    ...
    onSuccess: (response, id) => {
      ...
      try {
        ...
        recordActivity({
          ...
          remarks: 'download file report bmpp group',
        });
      } catch (error) {
  ...
  const getActionOptions = (row: any) => {
    ...
    switch (status) {
      case 'success':
        return [
          {
            apiDownload: 'report.bmppGroup.download',
            iconName: 'download',
