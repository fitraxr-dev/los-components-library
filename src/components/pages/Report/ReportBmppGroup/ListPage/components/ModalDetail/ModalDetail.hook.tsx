...
import useGetDataReportBmppGroupDetailExisting from '@/hooks/services/report/report-bmpp-group/useGetDataReportBmppGroupDetailExisting';
import useGetDataReportBmppGroupDetailProposed from '@/hooks/services/report/report-bmpp-group/useGetDataReportBmppGroupDetailProposed';
...
const useModalDetail = ({ id }: ModalDetailProps) => {
  ...
  const { data: dataExisting, isFetching: isLoadingExisting } = useGetDataReportBmppGroupDetailExisting({
    filter: {
      calculationId: id,
    },
    page: {
  ...
  const { data: dataProposed, isFetching: isLoadingProposed } = useGetDataReportBmppGroupDetailProposed({
    filter: {
      calculationId: id,
    },
    page: {
