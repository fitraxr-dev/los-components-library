...
import useDownloadReportTatSlaSum from '@/hooks/services/report/report-tat-sla-sum/useDownloadReportTatSlaSum';
import useGenerateHistoryTatSlaSum from '@/hooks/services/report/report-tat-sla-sum/useGenerateHistoryTatSlaSum';
...
const useTabHistoryDownload = () => {
  ...
  const { data, isLoading, refetch } = useGenerateHistoryTatSlaSum({
    page: {
  ...
  const { mutate: downloadReport, isPending: isDownloading } = useDownloadReportTatSlaSum({
    onError: (error) => {
    ...
    onSuccess: (response, id) => {
      ...
      try {
        ...
        recordActivity({
          ...
          remarks: 'download file report tat-sla-sum',
        });
      } catch (error) {
