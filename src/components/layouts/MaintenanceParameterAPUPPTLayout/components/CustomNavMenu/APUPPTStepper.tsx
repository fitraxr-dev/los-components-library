...
import { useAPUPPTStepper } from './useAPUPPTStepper';


interface APUPPTStepperProps {
  sx?: Record<string, any>;
}

const APUPPTStepper: React.FC<APUPPTStepperProps> = ({ sx = {} }) => {
  const theme = useTheme();
  const config = getStepperConfig('parameter-mapping-apu_ppt');
