...
const FinancingOverview = () => {
  ...
  return (
    <ColumnWrapper sx={{ gap: 3 }}>
      ...
      <TableDebtorInformation module={TypeModule.MIP_REVIEW} process={TypeProcess.REVIEWER_DH} />
        ...
        <ColumnWrapper sx={{ gap: 3, mt: 2 }}>
          ...
          {needCheckMaster && (
            <TextStyle weight={500}>
              Data Sebelumnya :{' '}
              {findDataMaster('typePermohonan') ? findLabelTypeSubmission(findDataMaster('typePermohonan')) : '-'}
            </TextStyle>
          )}
          ...
          />
          {needCheckMaster && (
            <TextStyle weight={500}>Data Sebelumnya : {findDataMaster('typePermohonanRemark') || '-'}</TextStyle>
          )}
        </ColumnWrapper>
      </SectionTitle>
