...
import { fullWidthCellKonven, fullWidthCellSyariah } from './ModalDetailFacility.constants';
import useDetailFacility from './ModalDetailFacility.hook';


const ModalDetailFacility = NiceModal.create(({ id, hidePK, idFacility }: any) => {
  const theme = useTheme();
  const modal = useModal();
  const modalId = MODALPK.DETAIL_FACILITY;
  ...
  const {
    ...
    pk,
    isSyariah,
  } = useDetailFacility(id, idFacility);
