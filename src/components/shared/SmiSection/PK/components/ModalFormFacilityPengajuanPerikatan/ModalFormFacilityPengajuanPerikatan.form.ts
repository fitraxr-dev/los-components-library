...
export const validation: MasintonValidation = {
  ...
  governmentMandate: [
    {
      errorMessage: 'Jaminan/Penugasan Pemerintah tidak boleh kosong',
      rule: /\S/,
    },
  ],
  gracePeriod: [
    {
      errorMessage: 'Masa Tenggang tidak boleh kosong',
      rule: /\S/,
    },
  ],
  mappingFinancingSegment: [
    {
      errorMessage: 'CORE Mapping Produk tidak boleh kosong',
      rule: /\S/,
    },
  ],
  mappingOrderType: [
  ...
  rates: [
    {
      errorMessage: 'Rates tidak boleh kosong',
      rule: /\S/,
    },
  ],
  timePeriod: [
    {
      errorMessage: 'Jangka Waktu tidak boleh kosong',
      rule: /\S/,
    },
  ],
  withdrawalPeriod: [
    {
      errorMessage: 'Masa Penarikan tidak boleh kosong',
      rule: /\S/,
    },
  ],
};
