...
const AlMusyarakahMutanaqisahForm = (props: SyariahFormsProps) => {
  const { onChangeSyariahForm, financingFacilityData, syariahComponentConfig } = props;
  ...
  return (
    <>
      ...
      >
        <Input
          label={getLabel('debtor_name', 'Mitra Syarik SMI')}
          type="text"
          placeholder={getLabel('debtor_name', 'Mitra Syarik SMI')}
          containerSx={{ flex: 1 }}
