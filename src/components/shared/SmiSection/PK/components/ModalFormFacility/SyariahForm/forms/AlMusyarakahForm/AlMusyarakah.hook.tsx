...
const useAlMusyarakah = (props: SyariahFormsProps) => {
  ...
  useEffect(() => {
    ...
    if (currencyDropdownList &&
      ...
      // Auto-fill hanya jika exchange_rate_global kosong atau 0
      if (finalRate && (!exchange_rate_global.value || exchange_rate_global.value === '0')) {
        masintonChange('exchange_rate_global', finalRate);
        hasAutoFilled = true;
      }
    }
