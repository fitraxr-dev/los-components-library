      ...
      <Box border="1px solid #D3D3D3" borderRadius="10px" padding={theme.spacing(3)}>
        <ColumnWrapper>
          {financingFacilityData?.currency_purchase_price === 'USD' && (
            ...
            >
              <CurrencyCell
                value={financingFacilityData.exchange_rate_purchase_price}
                currency={financingFacilityData?.currency_purchase_price === 'USD' ? 'IDR' : 'USD'}
                valueTitle="Konversi Mata Uang"
              />
            </Box>
          )}
          <Box
                    ...
                    <Tooltip
                      ...
                      title={
                        (() => {
                          ...
                          const exchangeRateFromApi = (financingFacilityData?.exchange_rate_purchase_price && financingFacilityData?.exchange_rate_purchase_price !== '0') ?
                            parseFloat(financingFacilityData.exchange_rate_purchase_price.toString().replace(/,/g, '')) :
          ...
          >
            ...
            {financingFacilityData.currencyOrderValue === 'IDR' ?
              <>
                            ...
                            <>
                              {item.key === 'down_payment' &&
                                <CurrencyCell
                                  ...
                                  rateTitle="Kurs"
                                  totalTitle="Uang Muka (Dalam Rp)"
                                />
                              }
                              {item.key === 'murabahah_margin' &&
                                <CurrencyCell
                                  value={financingFacilityData.murabahah_margin}
                                  currency={financingFacilityData?.currency_murabahah_margin}
                                  rate={financingFacilityData?.exchange_rate_murabahah_margin}
                                  idrValue={financingFacilityData?.murabahah_margin_idr}
                                  valueTitle="Margin Murabahah"
                                  rateTitle="Kurs"
                                  totalTitle="Margin Murabahah (Dalam Rp)"
                                />
                              }
                              {item.key === 'selling_price' &&
                                <CurrencyCell
                                  ...
                                  rate={financingFacilityData?.exchange_rate_selling_price}
                ...
                >
                  <CurrencyCell
                    value={financingFacilityData.murabahah_installment}
                    currency={financingFacilityData?.currency_murabahah_installment}
                    rate={financingFacilityData?.exchange_rate_murabahah_installment}
                    idrValue={financingFacilityData?.murabahah_installment_idr}
                    valueTitle="Nilai Angsuran Murabahah"
                    rateTitle="Kurs"
                    totalTitle="Nilai Angsuran Murabahah (Dalam Rp)"
                  />
                </Box>
              </>
              :
              <>
                <Box border="1px solid #D3D3D3" borderRadius="10px" padding="10px" gap="20px" display="flex" flexDirection="column">
                  <Box
                    sx={{
                      display: 'grid',
                      gridGap: theme.spacing(3),
            ...
            >
              {additionalData?.slice(4, 7)?.filter((item) => item.type !== 'currency').map((item, index) => {
                return (
                  <Cell key={index} title={item.label} value={item.value} />
                );
              }
