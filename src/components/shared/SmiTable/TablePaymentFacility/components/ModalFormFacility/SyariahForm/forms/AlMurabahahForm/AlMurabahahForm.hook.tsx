...
const useAlMurabahah = (props: SyariahFormsProps) => {
  ...
  useEffect(() => {
    ...
    if (currencyDropdownList) {
      ...
      initRate('exchange_rate_purchase_price', 'currency_purchase_price', 'exchange_rate_purchase_price');
      initRate('exchange_rate_murabahah_margin', 'currency_murabahah_margin', 'exchange_rate_murabahah_margin');
      initRate('exchange_rate_down_payment', 'currency_down_payment', 'exchange_rate_down_payment');
      initRate('exchange_rate_murabahah_installment', 'currency_murabahah_installment', 'exchange_rate_murabahah_installment');
    }
