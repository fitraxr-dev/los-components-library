...
const AlMusyarakah = (props: SyariahFormsProps) => {
  ...
  const { existing, facilityId, syariahComponentConfig, disabled } = props;
          ...
          <Box sx={{ position: 'relative' }}>
            ...
            <RowWrapper sx={{ alignItems: 'center', gap: 1 }}>
              ...
              <Currency
                ...
                onCurrencyChange={(val) => {
                  const isBothIdr = val === 'IDR' && currency_partnership_smi.value === 'IDR';
                  const fallbackRate = currencyDropdownList.find((dt) => dt.value === 'USD')?.rate;
                  ...
                  if (isBothIdr) {
                    ...
                    const finalRate = (val === 'USD' || currency_partnership_smi.value === 'USD')
                      ? (fallbackRate || '1')
                      : '1';
            ...
            <Box sx={{ position: 'relative' }}>
              <Box sx={{ alignItems: 'center', display: 'flex', gap: 1, mb: 1 }}>
                <TextStyle variant="body4" weight={600} color={theme.palette.grey[400]}>
                  {getLabel('total_partnership_idr', 'Total Syirkah (dalam Rp)')}
                </TextStyle>
              </Box>
              <Currency
                currencyList={currencyDropdownList}
