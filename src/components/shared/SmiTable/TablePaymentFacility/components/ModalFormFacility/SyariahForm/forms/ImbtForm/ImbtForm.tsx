        ...
        >
          ...
          >
            <Box sx={{ position: 'relative' }}>
              <Box sx={{ alignItems: 'center', display: 'flex', gap: 1, mb: 1 }}>
                <TextStyle variant="body4" weight={600} color={theme.palette.custom.text}>
                  {getLabel('imbt_transfer_value', 'Nilai Pengalihan Objek IMBT')}
                </TextStyle>
              </Box>
              <CurrencyForm
                initialProps={{
                  ...
                  onCurrencyChange: (val) => {
                    if (val.currency === 'IDR') {
                      ...
                      masintonMultiChange({
                        currency_imbt_transfer_value: val,
                        exchange_rate_imbt_transfer: fallbackRate || '1',
                      });
                    }
                  },
                  placeholder: getLabel('imbt_transfer_value', 'Nilai Pengalihan Objek IMBT'),
