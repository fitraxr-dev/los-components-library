          ...
          initialProps={{
            ...
            onCurrencyChange: (val) => {
              if (val.currency === 'IDR') {
                ...
                masintonMultiChange({
                  currency_installment_value: val,
                  exchange_rate_installment: fallbackRate || '1',
                });
              }
            },
                ...
                <Tooltip
                  ...
                  title={
                    (() => {
                      ...
                      const exchangeRateFromApi = (exchange_rate_al_qardh_loan?.value && exchange_rate_al_qardh_loan?.value !== '0') ?
                        parseFloat(exchange_rate_al_qardh_loan.value.toString().replace(/,/g, '')) :
              ...
              <Currency
                ...
                onCurrencyChange={(val) => {
                  if (val === 'IDR') {
                    ...
                    masintonMultiChange({
                      currency_al_qardh_loan_amount: val,
                      exchange_rate_al_qardh_loan: fallbackRate || '1',
                    });
                  }
                }}
                onChange={(val) => {
                ...
                initialProps={{
                  ...
                  onCurrencyChange: (val) => {
                    if (val.currency === 'IDR') {
                      ...
                      masintonMultiChange({
                        currency_administration_fee: val,
                        exchange_rate_administration_fee: fallbackRate || '1',
                      });
                    }
                  },
