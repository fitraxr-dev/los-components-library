...
const useGenerateReportExcelLaporanCustomerLPA = (
  ...
  const mutation = useMutation({
    mutationFn: async (payload: any) => {
      try {
        ...
        const response = await API('report.customerLPA.excel', { data: { filter: payload } });
...
export default useGenerateReportExcelLaporanCustomerLPA;
