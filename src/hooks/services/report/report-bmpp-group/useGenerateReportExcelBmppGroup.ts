...
const useGenerateReportExcelBmppGroup = (
  ...
  const mutation = useMutation({
    mutationFn: async (payload: any) => {
      try {
        ...
        const response = await API('report.bmppGroup.excel', { data: { filter: payload } });
...
export default useGenerateReportExcelBmppGroup;
