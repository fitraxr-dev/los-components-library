...
const useGenerateReportExcelBmppGroupDpop = (
  ...
  const mutation = useMutation({
    mutationFn: async (payload: any) => {
      try {
        ...
        const response = await API('report.bmppGroupDpop.excel', { data: { filter: payload } });
...
export default useGenerateReportExcelBmppGroupDpop;
