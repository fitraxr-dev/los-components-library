...
const useGenerateReportExcelLogEndOfDay = (
  ...
  const mutation = useMutation({
    mutationFn: async (payload: any) => {
      try {
        ...
        const response = await API('report.logEndofDay.excel', { data: { filter: payload } });
...
export default useGenerateReportExcelLogEndOfDay;
