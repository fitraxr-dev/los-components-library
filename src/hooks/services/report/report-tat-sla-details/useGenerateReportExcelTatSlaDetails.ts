...
const useGenerateReportExcelTatSlaDetails = (
  ...
  const mutation = useMutation({
    mutationFn: async (payload: any) => {
      try {
        ...
        const response = await API('report.tatSlaDetails.excel', { data: { filter: payload } });
...
export default useGenerateReportExcelTatSlaDetails;
