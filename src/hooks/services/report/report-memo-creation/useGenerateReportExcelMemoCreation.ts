...
const useGenerateReportExcelMemoCreation = (
  ...
  const mutation = useMutation({
    mutationFn: async (payload: any) => {
      try {
        ...
        const response = await API('report.memoCreation.excel', { data: { filter: payload } });
...
export default useGenerateReportExcelMemoCreation;
